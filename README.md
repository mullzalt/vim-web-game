...
<h3 align="center">Vim Web Game</h3>

  <p align="center">
    A community-driven Vim gamification learning platform for improving Vim skills.
    <!-- <br /> -->
...
Make sure these programs are installed on your machine.
...
1. Clone the repo
   ```sh
   git clone https://github.com/mullzalt/vim-web-game.git
   ```
...
[repo-url]: https://github.com/mullzalt/vim-web-game/
